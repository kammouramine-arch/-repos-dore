...
--   20260818093637_init
--   20260819115735_mobile_push_billing
--
...
-- Garde-fou : une base déjà initialisée doit être migrée par
-- `npm run db:deploy:production`, pas réinitialisée à la main.
DO $$
BEGIN
  IF EXISTS (
...
-- Journal des migrations, dans la forme exacte attendue par Prisma.
...
-- Enregistrement de « 20260818093637_init » comme appliquée.
INSERT INTO "_prisma_migrations"
  ("id", "checksum", "migration_name", "started_at", "finished_at", "applied_steps_count")
VALUES
  (gen_random_uuid()::text, '05398491b474a68407deb771cea2a8436f7093acea85887374e27d535dcea662', '20260818093637_init', now(), now(), 1);
...
-- Enregistrement de « 20260819115735_mobile_push_billing » comme appliquée.
INSERT INTO "_prisma_migrations"
  ("id", "checksum", "migration_name", "started_at", "finished_at", "applied_steps_count")
VALUES
  (gen_random_uuid()::text, '7a30c020c8fa39978c1a097870b4d866084f1b089babb475434a9f941ee978ca', '20260819115735_mobile_push_billing', now(), now(), 1);

COMMIT;

-- Vérification — doit renvoyer 32 tables applicatives et 2 migration(s).
SELECT
  (SELECT count(*) FROM information_schema.tables
    WHERE table_schema = 'public' AND table_type = 'BASE TABLE') - 1 AS tables_applicatives,
