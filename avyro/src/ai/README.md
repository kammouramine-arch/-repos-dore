...
> Avyro is the world’s first AI Driving Companion. This directory is where that
> claim eventually becomes code.
...
1. Define the port in `src/core/domain/ports` — e.g. `CompanionEngine`, in
   terms of Avyro's own entities (`Route`, `NavigationProgress`, `Place`).
