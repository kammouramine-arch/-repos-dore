...
export default function CompteScreen() {
  ...
  async function perform(fn: () => Promise<void>) {
    ...
    try { await fn(); }
    catch (cause) { setError(cause instanceof Error ? cause.message : (en ? 'Try again in a moment. Your entries are kept.' : 'Réessayez dans un instant. Vos saisies sont conservées.')); }
