...
export const DEFAULT_CATALOGUE: Catalogue = {
  ...
  plans: {
    ...
    plus: {
      ...
      pricing: {
        monthly: { amount: 999, currency: 'EUR', productId: 'lifeos.plus.monthly' },
        yearly: { amount: 7999, currency: 'EUR', productId: 'lifeos.plus.yearly' },
      },
      trialDays: 7,
      models: {
        model: MODEL_CAPABLE,
    ...
    pro: {
      ...
      pricing: {
        monthly: { amount: 1999, currency: 'EUR', productId: 'lifeos.pro.monthly' },
        yearly: { amount: 15999, currency: 'EUR', productId: 'lifeos.pro.yearly' },
      },
      trialDays: 7,
      models: {
        model: MODEL_CAPABLE,
    ...
    ultra: {
      ...
      pricing: {
        monthly: { amount: 4999, currency: 'EUR', productId: 'lifeos.ultra.monthly' },
        yearly: { amount: 39999, currency: 'EUR', productId: 'lifeos.ultra.yearly' },
      },
      trialDays: 7,
      models: {
        model: MODEL_CAPABLE,
