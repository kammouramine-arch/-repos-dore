...
final class SearchViewModelTests: XCTestCase {
    ...
    func testPlumberPressureQueryRanksRepressuriseFirstWithABestAnswer() throws {
    ...
    func testObjectNameAloneGivesNoBestAnswer() {
    ...
    func testDadAndBoilerQueryPrefersWhatDadShowedOnTheBoiler() {
