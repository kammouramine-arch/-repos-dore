#!/usr/bin/env node
/**
 * Renders Nova's launcher and splash artwork from the same geometry the app
 * draws on screen (see `src/ui/components/NovaMark.tsx`).
 *
...
// App icon: the mark on Nova's background, filling the platform's safe area.
