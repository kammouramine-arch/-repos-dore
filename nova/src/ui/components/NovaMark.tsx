...
/**
 * Nova's mark: a heading arrow, cut from the brand gradient, with one facet
 * catching the light. Vector so it stays crisp from a 20 pt header to a
 * full-screen splash.
 */
export const NovaMark = ({ size = 72, ring = true }: NovaMarkProps) => (
  <Svg width={size} height={size} viewBox="0 0 64 64">
    <Defs>
      <LinearGradient id="novaMarkFill" x1="0" y1="0" x2="1" y2="1">
    ...
    <Path d="M32 10 L52.5 50 32 39.5 11.5 50 Z" fill="url(#novaMarkFill)" />
