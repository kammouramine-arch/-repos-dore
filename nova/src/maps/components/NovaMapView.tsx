...
export interface NovaMapViewProps extends MapViewProps {
 ...
 *
 * Android renders Google Maps with Nova's night style; iOS uses Apple Maps,
 * which honours `userInterfaceStyle` and needs no API key. Platform chrome
 * (compass, toolbar, default location dot) is switched off — Nova draws its
 * own controls so both platforms look identical.
 */
export const NovaMapView = ({
  mapRef,
  appearance = 'standard',
  children,
  style,
